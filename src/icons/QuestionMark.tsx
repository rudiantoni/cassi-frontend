...
const QuestionMark: React.FC<QuestionMarkProps> = (props) => {
  return (
    <>
      <svg height="800px" width="600px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
        viewBox="0 0 302.967 302.967" xmlSpace="preserve" {...props} >
      <g>
        <g>
          <g>
            <path style={{fill: '#005d9b'}} d="M151.483,302.967C67.956,302.967,0,235.017,0,151.483S67.956,0,151.483,0
          ...
          <g>
            <g>
              <path style={{fill: '#005d9b'}} d="M116.586,118.12c1.795-4.607,4.297-8.588,7.511-11.961c3.225-3.389,7.114-6.016,11.667-7.898
